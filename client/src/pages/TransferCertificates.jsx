...
const TransferCertificates = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search Filter bar */}
      <div className="rounded-card border border-gray-200 bg-white p-5 shadow-flat flex items-center justify-between no-print">
        <SearchBar 
          value={search} 
          onChange={setSearch} 
          placeholder="Search by student name or TC number..." 
        />
      </div>
      ...
      <DataTable
        ...
        emptyMessage="No Transfer Certificates have been issued matching your query."
      />
