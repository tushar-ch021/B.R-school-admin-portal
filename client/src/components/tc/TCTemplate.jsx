      ...
      <div className="relative z-10 flex flex-col justify-between h-full space-y-6 px-4 py-2">
        ...
        <div className="text-center border-b border-navy-900/10 pb-4">
          ...
          <p className="text-[10px] font-semibold text-gray-500 uppercase">
            Atta, Gulaothi-Saidpur Road, Bulandshahr (BSR), U.P.
          </p>
          <p className="text-[9px] text-gray-400 mt-0.5">
            Affiliated to CBSE, New Delhi | School Code: BRIS | School No: 99999
          </p>
        </div>
        ...
        {/* 6. Signatures Area */}
        <div className="flex justify-between items-end pt-12 text-[10px] font-bold uppercase tracking-wider text-gray-900">
